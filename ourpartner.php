...
<aside id="fh5co-hero" clsas="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(images/banner/pathnership_1.jpg);">
							...
							<div class="spacer20">
							 ...
							 <div class="container">
						        ...
						        <div class="gallery col-lg-12 col-md-12 col-sm-12 col-xs-12">
						            <h1 class="gallery-title">Our Partner</h1>
						        </div>

						        
						            <div class="gallery_product col-lg-3 col-md-3 col-sm-3 col-xs-6 filter hdpe">
						                <img src="images/logo/ibm_partner_logo.png" class="img-responsive">
						            </div>

						            <div class="gallery_product col-lg-3 col-md-3 col-sm-3 col-xs-6 filter sprinkle">
						                <img src="images/logo/hp_partner_logo.png" class="img-responsive">
						            </div>

						            <div class="gallery_product col-lg-3 col-md-3 col-sm-3 col-xs-6 filter hdpe">
						                <img src="images/logo/lenovo_logo3.png" class="img-responsive">
						            </div>

						            <div class="gallery_product col-lg-3 col-md-3 col-sm-3 col-xs-6 filter irrigation">
						                <img src="images/logo/Huawei_logo.png" class="img-responsive">
						            </div>
								<div class="col-lg-12">
						            <div class="gallery_product col-lg-3 col-md-3 col-sm-3 col-xs-6 filter spray">
						                <img src="images/logo/microsoft_logo.png" class="img-responsive">
						            </div>

						            <div class="gallery_product col-lg-3 col-md-3 col-sm-3 col-xs-6 filter irrigation">
						                <img src="images/logo/western_digital_logo.png" class="img-responsive">
						            </div>

						            <div class="gallery_product col-lg-3 col-md-3 col-sm-3 col-xs-6 filter spray">
						                <img src="images/logo/Samsung_Logo.png" class="img-responsive">
						            </div>

						            <div class="gallery_product col-lg-3 col-md-3 col-sm-3 col-xs-6 filter irrigation">
						                <img src="images/logo/oracle_logo.gif" class="img-responsive">
						            </div>
								</div>
								<div class="col-lg-12">
						            <div class="gallery_product col-lg-3 col-md-3 col-sm-3 col-xs-6 filter irrigation">
						            ...
						            <div class="gallery_product col-lg-3 col-md-3 col-sm-3 col-xs-6 filter spray">
						                <img src="images/logo/windowsos_logo.jpg" class="img-responsive">
						            </div>
						            ...
						            <div class="gallery_product col-lg-3 col-md-3 col-sm-3 col-xs-6 filter sprinkle">
						                <img src="images/logo/Sanofi_logo.png" class="img-responsive">
						            </div>
						            <div class="gallery_product col-lg-3 col-md-3 col-sm-3 col-xs-6 filter sprinkle">
